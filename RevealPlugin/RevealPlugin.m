...
- (BOOL)checkRevealDylibWithInspectToolType:(InspectToolType)aType
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        dylibPath3 = @"/Applications/SyncApps/Reveal.app/Contents/SharedSupport/iOS-Libraries/libReveal.dylib";
        [@[dylibPath1, dylibPath2, dylibPath3] enumerateObjectsUsingBlock:^(NSString*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            if ([[NSFileManager defaultManager] fileExistsAtPath:obj]) {
                self.revealDyLibPath = obj;
                *stop = YES;
            }
        }];
        
        dylibPath1 = @"/Applications/Spark Inspector.app/Contents/Resources/Frameworks/SparkInspector.dylib";
        dylibPath2 = [@"~/Applications/Spark Inspector.app/Contents/Resources/Frameworks/SparkInspector.dylib"
                      stringByResolvingSymlinksInPath];
        dylibPath3 = @"/Applications/SyncApps/Spark Inspector/Spark Inspector.app/Contents/Resources/Frameworks/SparkInspector.dylib";
        [@[dylibPath1, dylibPath2, dylibPath3] enumerateObjectsUsingBlock:^(NSString*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            if ([[NSFileManager defaultManager] fileExistsAtPath:obj]) {
                self.sparkDyLibPath = obj;
                *stop = YES;
            }
        }];
    });
